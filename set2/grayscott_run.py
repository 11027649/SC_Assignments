...
def main():
    ...
    for i in range(5000):
        ...
        if i % 50 == 0:
            ...
            plt.savefig("results/grayscott/time_" + str(i) + "_" + str(t) + ".png", dpi=500)

    np.savetxt("results/grayscott/conc_u.txt", gs.total_u)
    np.savetxt("results/grayscott/conc_v.txt", gs.total_v)
